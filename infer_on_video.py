...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_path', type=str, default='input_video4.mp4', help='path to input video')
    parser.add_argument('--video_out_path', type=str, default = 'output_video4.mp4', help='path to output video')
